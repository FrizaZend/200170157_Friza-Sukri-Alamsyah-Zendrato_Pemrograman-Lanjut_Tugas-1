    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('dataMahasiswa.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="Kelas" placeholder="Kelas Mata Kuliah">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="Nama_Mata_Kuliah" placeholder="Nama Mata Kuliah ">
            </div>
            <div class="mb-3">
